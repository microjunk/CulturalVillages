...
public class CulturalScatteredFeatures
{
    private static final String __OBFID = "CL_00000473";

    public static void registerScatteredFeaturePieces()
    {
        MapGenStructureIO.registerStructureComponent(CulturalScatteredFeatures.DesertPyramid.class, "TeDP");
        MapGenStructureIO.registerStructureComponent(CulturalScatteredFeatures.JunglePyramid.class, "TeJP");
        MapGenStructureIO.registerStructureComponent(CulturalScatteredFeatures.SwampHut.class, "TeSH");
    }

    public static class DesertPyramid extends CulturalScatteredFeatures.Feature
        {
    ...
    abstract static class Feature extends StructureComponent
        {
            ...
            protected Feature(Random p_i2065_1_, int p_i2065_2_, int p_i2065_3_, int p_i2065_4_, int p_i2065_5_, int p_i2065_6_, int p_i2065_7_)
            {
                ...
                switch (CulturalScatteredFeatures.SwitchEnumFacing.field_175956_a[this.coordBaseMode.ordinal()])
                {
                    case 1:
                    case 2:
    ...
    public static class JunglePyramid extends CulturalScatteredFeatures.Feature
        {
            ...
            private static CulturalScatteredFeatures.JunglePyramid.Stones junglePyramidsRandomScatteredStones = new CulturalScatteredFeatures.JunglePyramid.Stones((CulturalScatteredFeatures.SwitchEnumFacing)null);
            ...
            static class Stones extends StructureComponent.BlockSelector
                {
                    ...
                    Stones(CulturalScatteredFeatures.SwitchEnumFacing p_i45583_1_)
                    {
                        this();
                    }
                }
    ...
    public static class SwampHut extends CulturalScatteredFeatures.Feature
        {
