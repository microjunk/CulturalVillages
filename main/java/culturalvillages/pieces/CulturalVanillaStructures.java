...
public class CulturalVanillaStructures
{
	private static final String __OBFID = "CL_00000516";

    public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.House1.class, "House1");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Field1.class, "Field1");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Field2.class, "Field2");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Torch.class, "Torch");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Hall.class, "Hall");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.House4Garden.class, "House4");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.WoodHut.class, "WoodHut");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Church.class, "Church");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.House2.class, "House2");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Start.class, "Start");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Path.class, "Path");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.House3.class, "House3");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Well.class, "Well");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.SmallTower.class, "SmallTower");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.House5.class, "House5");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Storage.class, "Storage");
        MapGenStructureIO.registerStructureComponent(CulturalVanillaStructures.Stable.class, "Stable");
    }

    public static List getStructureVillageWeightedPieceList(Random p_75084_0_, int p_75084_1_)
    {
        ArrayList arraylist = Lists.newArrayList();
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.House4Garden.class, 4, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.Church.class, 20, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 1 + p_75084_1_)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.House1.class, 20, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.WoodHut.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 5 + p_75084_1_ * 3)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.Hall.class, 15, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.Field1.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 1 + p_75084_1_, 4 + p_75084_1_)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.Field2.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.House2.class, 15, MathHelper.getRandomIntegerInRange(p_75084_0_, 0, 1 + p_75084_1_)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.House3.class, 8, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 3 + p_75084_1_ * 2)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.SmallTower.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 1 + p_75084_1_)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.House5.class, 8, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 3 + p_75084_1_ * 2)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.Storage.class, 4, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 5 + p_75084_1_ * 2)));
        arraylist.add(new CulturalVanillaStructures.PieceWeight(CulturalVanillaStructures.Stable.class, 4, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        ...
        {
            if (((CulturalVanillaStructures.PieceWeight)iterator.next()).villagePiecesLimit == 0)
            {
                iterator.remove();
            }
        }
    ...
    private static int func_75079_a(List p_75079_0_)
    {
        boolean flag = false;
        int i = 0;
        CulturalVanillaStructures.PieceWeight pieceweight;

        for (Iterator iterator = p_75079_0_.iterator(); iterator.hasNext(); i += pieceweight.villagePieceWeight)
        {
            pieceweight = (CulturalVanillaStructures.PieceWeight)iterator.next();
    ...
    private static CulturalVanillaStructures.Village func_176065_a(CulturalVanillaStructures.Start p_176065_0_, CulturalVanillaStructures.PieceWeight p_176065_1_, List p_176065_2_, Random p_176065_3_, int p_176065_4_, int p_176065_5_, int p_176065_6_, EnumFacing p_176065_7_, int p_176065_8_)
    {
        Class oclass = p_176065_1_.villagePieceClass;
        Object object = null;

        if (oclass == CulturalVanillaStructures.House4Garden.class)
        {
            object = CulturalVanillaStructures.House4Garden.func_175858_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.Church.class)
        {
            object = CulturalVanillaStructures.Church.func_175854_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.House1.class)
        {
            object = CulturalVanillaStructures.House1.func_175850_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.WoodHut.class)
        {
            object = CulturalVanillaStructures.WoodHut.func_175853_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.Hall.class)
        {
            object = CulturalVanillaStructures.Hall.func_175857_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.Field1.class)
        {
            object = CulturalVanillaStructures.Field1.func_175851_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.Field2.class)
        {
            object = CulturalVanillaStructures.Field2.func_175852_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.House2.class)
        {
            object = CulturalVanillaStructures.House2.func_175855_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.House3.class)
        {
            object = CulturalVanillaStructures.House3.func_175849_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.SmallTower.class)
        {
            object = CulturalVanillaStructures.SmallTower.func_175860_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.House5.class)
        {
            object = CulturalVanillaStructures.House5.func_175861_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.Storage.class)
        {
            object = CulturalVanillaStructures.Storage.func_175862_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalVanillaStructures.Stable.class)
        {
            object = CulturalVanillaStructures.Stable.func_175863_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else
        {
        ...
        return (CulturalVanillaStructures.Village)object;
    }

    private static CulturalVanillaStructures.Village func_176067_c(CulturalVanillaStructures.Start p_176067_0_, List p_176067_1_, Random p_176067_2_, int p_176067_3_, int p_176067_4_, int p_176067_5_, EnumFacing p_176067_6_, int p_176067_7_)
    {
        ...
        else
        {
            ...
            while (j1 < 5)
            {
                ...
                while (iterator.hasNext())
                {
                    CulturalVanillaStructures.PieceWeight pieceweight = (CulturalVanillaStructures.PieceWeight)iterator.next();
                    ...
                    if (k1 < 0)
                    {
                        ...
                        CulturalVanillaStructures.Village village = func_176065_a(p_176067_0_, pieceweight, p_176067_1_, p_176067_2_, p_176067_3_, p_176067_4_, p_176067_5_, p_176067_6_, p_176067_7_);
            ...
            StructureBoundingBox structureboundingbox = CulturalVanillaStructures.Torch.func_175856_a(p_176067_0_, p_176067_1_, p_176067_2_, p_176067_3_, p_176067_4_, p_176067_5_, p_176067_6_);

            if (structureboundingbox != null)
            {
                return new CulturalVanillaStructures.Torch(p_176067_0_, p_176067_7_, p_176067_2_, structureboundingbox, p_176067_6_);
            }
            else
            {
                return null;
    ...
    private static StructureComponent func_176066_d(CulturalVanillaStructures.Start p_176066_0_, List p_176066_1_, Random p_176066_2_, int p_176066_3_, int p_176066_4_, int p_176066_5_, EnumFacing p_176066_6_, int p_176066_7_)
    {
        if (p_176066_7_ > 50)
        {
            return null;
    ...
    private static StructureComponent func_176069_e(CulturalVanillaStructures.Start p_176069_0_, List p_176069_1_, Random p_176069_2_, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing p_176069_6_, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = CulturalVanillaStructures.Path.func_175848_a(p_176069_0_, p_176069_1_, p_176069_2_, p_176069_3_, p_176069_4_, p_176069_5_, p_176069_6_);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                CulturalVanillaStructures.Path path = new CulturalVanillaStructures.Path(p_176069_0_, p_176069_7_, p_176069_2_, structureboundingbox, p_176069_6_);
    ...
    public static class Church extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000525";

            public Church() {}

            public Church(CulturalVanillaStructures.Start p_i45564_1_, int p_i45564_2_, Random p_i45564_3_, StructureBoundingBox p_i45564_4_, EnumFacing p_i45564_5_)
            {
            ...
            public static CulturalVanillaStructures.Church func_175854_a(CulturalVanillaStructures.Start p_175854_0_, List p_175854_1_, Random p_175854_2_, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing p_175854_6_, int p_175854_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new CulturalVanillaStructures.Church(p_175854_0_, p_175854_7_, p_175854_2_, structureboundingbox, p_175854_6_) : null;
            }
    ...
    public static class Field1 extends CulturalVanillaStructures.Village
        {
            ...
            public Field1(CulturalVanillaStructures.Start p_i45570_1_, int p_i45570_2_, Random p_i45570_3_, StructureBoundingBox p_i45570_4_, EnumFacing p_i45570_5_)
            {
            ...
            public static CulturalVanillaStructures.Field1 func_175851_a(CulturalVanillaStructures.Start p_175851_0_, List p_175851_1_, Random p_175851_2_, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing p_175851_6_, int p_175851_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new CulturalVanillaStructures.Field1(p_175851_0_, p_175851_7_, p_175851_2_, structureboundingbox, p_175851_6_) : null;
            }
    ...
    public static class Field2 extends CulturalVanillaStructures.Village
        {
            /** First crop type for this field. */
            private Block cropTypeA;
            /** Second crop type for this field. */
            ...
            public Field2(CulturalVanillaStructures.Start p_i45569_1_, int p_i45569_2_, Random p_i45569_3_, StructureBoundingBox p_i45569_4_, EnumFacing p_i45569_5_)
            {
            ...
            public static CulturalVanillaStructures.Field2 func_175852_a(CulturalVanillaStructures.Start p_175852_0_, List p_175852_1_, Random p_175852_2_, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing p_175852_6_, int p_175852_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new CulturalVanillaStructures.Field2(p_175852_0_, p_175852_7_, p_175852_2_, structureboundingbox, p_175852_6_) : null;
            }
    ...
    public static class Hall extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000522";

            public Hall() {}

            public Hall(CulturalVanillaStructures.Start p_i45567_1_, int p_i45567_2_, Random p_i45567_3_, StructureBoundingBox p_i45567_4_, EnumFacing p_i45567_5_)
            {
            ...
            public static CulturalVanillaStructures.Hall func_175857_a(CulturalVanillaStructures.Start p_175857_0_, List p_175857_1_, Random p_175857_2_, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing p_175857_6_, int p_175857_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new CulturalVanillaStructures.Hall(p_175857_0_, p_175857_7_, p_175857_2_, structureboundingbox, p_175857_6_) : null;
            }
    ...
    public static class House1 extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000517";

            public House1() {}

            public House1(CulturalVanillaStructures.Start p_i45571_1_, int p_i45571_2_, Random p_i45571_3_, StructureBoundingBox p_i45571_4_, EnumFacing p_i45571_5_)
            {
            ...
            public static CulturalVanillaStructures.House1 func_175850_a(CulturalVanillaStructures.Start p_175850_0_, List p_175850_1_, Random p_175850_2_, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing p_175850_6_, int p_175850_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new CulturalVanillaStructures.House1(p_175850_0_, p_175850_7_, p_175850_2_, structureboundingbox, p_175850_6_) : null;
            }
    ...
    public static class House2 extends CulturalVanillaStructures.Village
        {
            ...
            public House2(CulturalVanillaStructures.Start p_i45563_1_, int p_i45563_2_, Random p_i45563_3_, StructureBoundingBox p_i45563_4_, EnumFacing p_i45563_5_)
            {
            ...
            public static CulturalVanillaStructures.House2 func_175855_a(CulturalVanillaStructures.Start p_175855_0_, List p_175855_1_, Random p_175855_2_, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing p_175855_6_, int p_175855_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new CulturalVanillaStructures.House2(p_175855_0_, p_175855_7_, p_175855_2_, structureboundingbox, p_175855_6_) : null;
            }
    ...
    public static class House3 extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000530";

            public House3() {}

            public House3(CulturalVanillaStructures.Start p_i45561_1_, int p_i45561_2_, Random p_i45561_3_, StructureBoundingBox p_i45561_4_, EnumFacing p_i45561_5_)
            {
            ...
            public static CulturalVanillaStructures.House3 func_175849_a(CulturalVanillaStructures.Start p_175849_0_, List p_175849_1_, Random p_175849_2_, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing p_175849_6_, int p_175849_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new CulturalVanillaStructures.House3(p_175849_0_, p_175849_7_, p_175849_2_, structureboundingbox, p_175849_6_) : null;
            }
    ...
    public static class House4Garden extends CulturalVanillaStructures.Village
        {
            ...
            public House4Garden(CulturalVanillaStructures.Start p_i45566_1_, int p_i45566_2_, Random p_i45566_3_, StructureBoundingBox p_i45566_4_, EnumFacing p_i45566_5_)
            {
            ...
            public static CulturalVanillaStructures.House4Garden func_175858_a(CulturalVanillaStructures.Start p_175858_0_, List p_175858_1_, Random p_175858_2_, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing p_175858_6_, int p_175858_7_)
            {
                ...
                return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new CulturalVanillaStructures.House4Garden(p_175858_0_, p_175858_7_, p_175858_2_, structureboundingbox, p_175858_6_);
            }
    ...
    public static class Path extends CulturalVanillaStructures.Road
        {
            ...
            public Path(CulturalVanillaStructures.Start p_i45562_1_, int p_i45562_2_, Random p_i45562_3_, StructureBoundingBox p_i45562_4_, EnumFacing p_i45562_5_)
            {
            ...
            public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                ...
                {
                    structurecomponent1 = this.getNextComponentNN((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, i);
                ...
                for (i = p_74861_3_.nextInt(5); i < this.averageGroundLevel - 8; i += 2 + p_74861_3_.nextInt(5))
                {
                    structurecomponent1 = this.getNextComponentPP((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, i);
                ...
                {
                    switch (CulturalVanillaStructures.SwitchEnumFacing.field_176064_a[this.coordBaseMode.ordinal()])
                    {
                        case 1:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                            break;
                        case 2:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                            break;
                        case 3:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                            break;
                        case 4:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
                ...
                if (flag && p_74861_3_.nextInt(3) > 0 && this.coordBaseMode != null)
                {
                    ...
                    {
                        case 1:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                            break;
                        case 2:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                            break;
                        case 3:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                            break;
                        case 4:
                            CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
            }

            public static StructureBoundingBox func_175848_a(CulturalVanillaStructures.Start p_175848_0_, List p_175848_1_, Random p_175848_2_, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing p_175848_6_)
            {
    ...
    public abstract static class Road extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000532";

            public Road() {}

            protected Road(CulturalVanillaStructures.Start p_i2108_1_, int p_i2108_2_)
            {
                super(p_i2108_1_, p_i2108_2_);
            }
        }

    public static class Start extends CulturalVanillaStructures.Well
        {
            ...
            public CulturalVanillaStructures.PieceWeight structVillagePieceWeight;
            /**
            ...
            {
                super((CulturalVanillaStructures.Start)null, 0, p_i2104_3_, p_i2104_4_, p_i2104_5_);
    ...
    public static class Torch extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000520";

            public Torch() {}

            public Torch(CulturalVanillaStructures.Start p_i45568_1_, int p_i45568_2_, Random p_i45568_3_, StructureBoundingBox p_i45568_4_, EnumFacing p_i45568_5_)
            {
            ...
            public static StructureBoundingBox func_175856_a(CulturalVanillaStructures.Start p_175856_0_, List p_175856_1_, Random p_175856_2_, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing p_175856_6_)
            {
    ...
    public abstract static class Village extends StructureComponent
        {
            ...
            private CulturalVanillaStructures.Start startPiece;

            public Village() {}

            protected Village(CulturalVanillaStructures.Start p_i2107_1_, int p_i2107_2_)
            {
                super(p_i2107_2_);
             ...
             */
            protected StructureComponent getNextComponentNN(CulturalVanillaStructures.Start p_74891_1_, List p_74891_2_, Random p_74891_3_, int p_74891_4_, int p_74891_5_)
            {
                if (this.coordBaseMode != null)
                {
                    ...
                    {
                        case 1:
                            return CulturalVanillaStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case 2:
                            return CulturalVanillaStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                        case 3:
                            return CulturalVanillaStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        case 4:
                            return CulturalVanillaStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    }
                }
             ...
             * Gets the next village component, with the bounding box shifted +1 in the X and Z direction.
             */
            protected StructureComponent getNextComponentPP(CulturalVanillaStructures.Start p_74894_1_, List p_74894_2_, Random p_74894_3_, int p_74894_4_, int p_74894_5_)
            {
                if (this.coordBaseMode != null)
                {
                    switch (CulturalVanillaStructures.SwitchEnumFacing.field_176064_a[this.coordBaseMode.ordinal()])
                    {
                        case 1:
                            return CulturalVanillaStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case 2:
                            return CulturalVanillaStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                        case 3:
                            return CulturalVanillaStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        case 4:
                            return CulturalVanillaStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    }
                }
    ...
    public static class Well extends CulturalVanillaStructures.Village
        {
            private static final String __OBFID = "CL_00000533";

            public Well() {}

            public Well(CulturalVanillaStructures.Start p_i2109_1_, int p_i2109_2_, Random p_i2109_3_, int p_i2109_4_, int p_i2109_5_)
            {
            ...
            public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
            {
                CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
                CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
                CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                CulturalVanillaStructures.func_176069_e((CulturalVanillaStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
            }
    ...
    public static class WoodHut extends CulturalVanillaStructures.Village
        {
            ...
            public WoodHut(CulturalVanillaStructures.Start p_i45565_1_, int p_i45565_2_, Random p_i45565_3_, StructureBoundingBox p_i45565_4_, EnumFacing p_i45565_5_)
            {
            ...
            public static CulturalVanillaStructures.WoodHut func_175853_a(CulturalVanillaStructures.Start p_175853_0_, List p_175853_1_, Random p_175853_2_, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing p_175853_6_, int p_175853_7_)
            {
                ...
                return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new CulturalVanillaStructures.WoodHut(p_175853_0_, p_175853_7_, p_175853_2_, structureboundingbox, p_175853_6_) : null;
            }
    ...
    public static class SmallTower extends CulturalVanillaStructures.Village
    {
        private static final String __OBFID = "CL_00000524";

        public SmallTower() {}

        public SmallTower(CulturalVanillaStructures.Start p_i45565_1_, int p_i45565_2_, Random p_i45565_3_, StructureBoundingBox p_i45565_4_, EnumFacing p_i45565_5_)
        {
            super(p_i45565_1_, p_i45565_2_);
            this.coordBaseMode = p_i45565_5_;
            this.boundingBox = p_i45565_4_;
        ...
        public static CulturalVanillaStructures.SmallTower func_175860_a(CulturalVanillaStructures.Start p_175853_0_, List p_175853_1_, Random p_175853_2_, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing p_175853_6_, int p_175853_7_)
        {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.func_175897_a(p_175853_3_, p_175853_4_, p_175853_5_, 0, 0, 0, 5, 12, 5, p_175853_6_);
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new CulturalVanillaStructures.SmallTower(p_175853_0_, p_175853_7_, p_175853_2_, structureboundingbox, p_175853_6_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 5, 12, 5, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 5, 0, 0, 5, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 5, 0, 1, 5, 2, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 5, 0, 4, 5, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 1, 5, 4, p_74875_3_);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 0, 4, 0, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 0, 0, 4, 4, 0, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 4, 0, 4, 4, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 0, 4, 4, 4, 4, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 0, 4, 1, 4, 4, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 6, 0, 0, 6, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 6, 0, 4, 6, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 6, 0, 3, 6, 0, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 6, 4, 3, 6, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 7, 0, 0, 8, 0, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 7, 0, 4, 8, 0, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 7, 4, 0, 8, 4, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 7, 4, 4, 8, 4, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            int i;
            int j;
            int k = this.getMetadataWithOffset(Blocks.oak_stairs, 3);
            this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 1, 9, 0, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 2, 9, 0, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(k), 3, 9, 0, p_74875_3_);
            int l = this.getMetadataWithOffset(Blocks.oak_stairs, 2);
            this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(l), 1, 9, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(l), 2, 9, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(l), 3, 9, 4, p_74875_3_);
            this.func_175804_a(worldIn, p_74875_3_, 1, 9, 1, 3, 9, 3, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            for (j = 0; j <= 4; ++j)
            {
            	i = this.getMetadataWithOffset(Blocks.oak_stairs, 0);
                this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(i), 0, 9, j, p_74875_3_);
            }
            for (j = 0; j <= 4; ++j)
            {
            	i = this.getMetadataWithOffset(Blocks.oak_stairs, 1);
                this.func_175811_a(worldIn, Blocks.oak_stairs.getStateFromMeta(i), 4, 9, j, p_74875_3_);
            }
            i = this.getMetadataWithOffset(Blocks.ladder, 3);
            ...
            this.spawnVillagers(worldIn, p_74875_3_, 1, 6, 2, 1);
            return false;
        }
    }
    
    public static class House5 extends CulturalVanillaStructures.Village
    {
        private static final String __OBFID = "CL_00000517";

        public House5() {}

        public House5(CulturalVanillaStructures.Start p_i45571_1_, int p_i45571_2_, Random p_i45571_3_, StructureBoundingBox p_i45571_4_, EnumFacing p_i45571_5_)
        {
            super(p_i45571_1_, p_i45571_2_);
            this.coordBaseMode = p_i45571_5_;
            this.boundingBox = p_i45571_4_;
        ...
        public static CulturalVanillaStructures.House5 func_175861_a(CulturalVanillaStructures.Start p_175850_0_, List p_175850_1_, Random p_175850_2_, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing p_175850_6_, int p_175850_7_)
        {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.func_175897_a(p_175850_3_, p_175850_4_, p_175850_5_, 0, 0, 0, 6, 10, 6, p_175850_6_);
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new CulturalVanillaStructures.House5(p_175850_0_, p_175850_7_, p_175850_2_, structureboundingbox, p_175850_6_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 0, 5, 9, 5, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 5, 0, 5, Blocks.sandstone.getDefaultState(), Blocks.sandstone.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 0, 1, 4, 0, 4, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);

            this.func_175804_a(worldIn, p_74875_3_, 1, 4, 1, 4, 4, 3, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 8, 1, 4, 8, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.jukebox.getDefaultState(), 3, 1, 4, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.chest, 1, 4, 1, 4, structureBoundingBox);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 2, 4, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 3, 4, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 4, 4, 4, p_74875_3_);
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 0, 0, 9, 0, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 5, 1, 0, 5, 9, 0, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 5, 0, 9, 5, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 5, 1, 5, 5, 9, 5, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 1, 0, 8, 4, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 5, 1, 1, 5, 8, 4, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 1, 0, 4, 8, 0, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 1, 5, 4, 8, 5, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 0, 6, 2, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 0, 6, 3, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 2, 6, 5, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 3, 6, 5, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 5, 6, 2, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 5, 6, 3, p_74875_3_);
            int i = this.getMetadataWithOffset(Blocks.ladder, 3);
            int j;
            
            for (j = 1; j <= 5; ++j)
            {
                this.func_175811_a(worldIn, Blocks.ladder.getStateFromMeta(i), 1, j, 4, p_74875_3_);
            }
            ...
            this.func_175810_a(worldIn, p_74875_3_, p_74875_2_, 1, 5, 0, EnumFacing.getHorizontal(this.getMetadataWithOffset(Blocks.oak_door, 1)));
            this.func_175811_a(worldIn, Blocks.stone_stairs.getStateFromMeta(this.getMetadataWithOffset(Blocks.stone_stairs, 3)), 1, 4, -1, p_74875_3_);
            
            
            this.spawnVillagers(worldIn, p_74875_3_, 1, 5, 2, 1);
            return true;
        }
    ...
    public static class Storage extends CulturalVanillaStructures.Village
    {
        private static final String __OBFID = "CL_00000517";

        public Storage() {}

        public Storage(CulturalVanillaStructures.Start p_i45571_1_, int p_i45571_2_, Random p_i45571_3_, StructureBoundingBox p_i45571_4_, EnumFacing p_i45571_5_)
        {
            super(p_i45571_1_, p_i45571_2_);
            this.coordBaseMode = p_i45571_5_;
            this.boundingBox = p_i45571_4_;
        ...
        public static CulturalVanillaStructures.Storage func_175862_a(CulturalVanillaStructures.Start p_175850_0_, List p_175850_1_, Random p_175850_2_, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing p_175850_6_, int p_175850_7_)
        {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.func_175897_a(p_175850_3_, p_175850_4_, p_175850_5_, 0, 0, 0, 5, 6, 5, p_175850_6_);
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new CulturalVanillaStructures.Storage(p_175850_0_, p_175850_7_, p_175850_2_, structureboundingbox, p_175850_6_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            this.func_175804_a(worldIn, p_74875_3_, 1, 1, 1, 3, 5, 4, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 4, 0, 4, Blocks.cobblestone.getDefaultState(), Blocks.cobblestone.getDefaultState(), false);
            //this.fillWithBlocks(world, p_74875_3_, 1, 0, 1, 2, 0, 3, Blocks.dirt, Blocks.dirt, false);

            this.func_175804_a(worldIn, p_74875_3_, 1, 4, 1, 3, 4, 3, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 0, 4, 1, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 0, 4, 2, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 0, 4, 3, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 1, 4, 0, p_74875_3_);
            ...
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 2, 4, 0, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 2, 4, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 3, 4, 0, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 3, 4, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 4, 4, 1, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 4, 4, 2, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 4, 4, 3, p_74875_3_);
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 0, 0, 4, 0, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 1, 0, 4, 4, 0, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 4, 0, 4, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 1, 4, 4, 4, 4, Blocks.log.getDefaultState(), Blocks.log.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 1, 1, 0, 3, 3, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 4, 1, 1, 4, 3, 3, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 1, 0, 3, 3, 0, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 1, 4, 3, 3, 4, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 0, 2, 2, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.glass_pane.getDefaultState(), 4, 2, 2, p_74875_3_);
            ...
            for (int i = 0; i < 5; ++i)
            {
                for (int j = 0; j < 5; ++j)
                {
                    //this.clearCurrentPositionBlocksUpwards(world, j, 6, i, p_74875_3_);
                    //this.func_151554_b(world, Blocks.sandstone, 0, j, -1, i, p_74875_3_);
                }
            }
    ...
    public static class Stable extends CulturalVanillaStructures.Village
    {
    	EntityHorse horse;
    	EntityHorse horse1;
        private static final String __OBFID = "CL_00000517";
        ...
        public Stable(CulturalVanillaStructures.Start p_i45571_1_, int p_i45571_2_, Random p_i45571_3_, StructureBoundingBox p_i45571_4_, EnumFacing p_i45571_5_)
        {
            super(p_i45571_1_, p_i45571_2_);
            this.coordBaseMode = p_i45571_5_;
            this.boundingBox = p_i45571_4_;
        ...
        public static CulturalVanillaStructures.Stable func_175863_a(CulturalVanillaStructures.Start p_175850_0_, List p_175850_1_, Random p_175850_2_, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing p_175850_6_, int p_175850_7_)
        {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.func_175897_a(p_175850_3_, p_175850_4_, p_175850_5_, 0, 0, 0, 10, 7, 15, p_175850_6_);
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new CulturalVanillaStructures.Stable(p_175850_0_, p_175850_7_, p_175850_2_, structureboundingbox, p_175850_6_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
        	this.horse = new EntityHorse(worldIn);
			((EntityHorse) horse).setHorseType(0);
			((EntityHorse) horse).setHorseVariant((int)Math.pow(2, (float)(8 + worldIn.rand.nextInt(4))) + worldIn.rand.nextInt(7));
			this.horse1 = new EntityHorse(worldIn);
			((EntityHorse) horse1).setHorseType(0);
			((EntityHorse) horse1).setHorseVariant((int)Math.pow(2, (float)(8 + worldIn.rand.nextInt(4))) + worldIn.rand.nextInt(7));
            ...
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 9, 7, 14, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            //this.fillWithBlocks(world, p_74875_3_, 2, 1, 6, 9, 4, 14, Blocks.air, Blocks.air, false);
            //this.fillWithBlocks(world, p_74875_3_, 0, 0, 0, 8, 0, 13, Blocks.dirt, Blocks.dirt, false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 8, 0, 13, Blocks.cobblestone.getDefaultState(), Blocks.cobblestone.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 0, 1, 7, 0, 12, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 1, 4, 1, 6, 4, 12, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.fence_gate, 1, 7, 1, 3, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 4, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 5, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 7, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 8, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.fence_gate, 1, 7, 1, 9, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 10, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.oak_fence.getDefaultState(), 7, 1, 11, p_74875_3_);
            this.func_175804_a(worldIn, p_74875_3_, 1, 1, 1, 1, 4, 12, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 7, 1, 1, 7, 4, 1, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 7, 1, 6, 7, 4, 6, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 7, 1, 12, 7, 4, 12, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 1, 1, 6, 1, 1, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 1, 6, 6, 1, 6, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 1, 12, 6, 1, 12, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 2, 1, 4, 2, 1, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 2, 6, 4, 2, 6, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 2, 12, 4, 2, 12, Blocks.oak_fence.getDefaultState(), Blocks.oak_fence.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 3, 1, 4, 3, 1, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 3, 6, 4, 3, 6, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 3, 12, 4, 3, 12, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 1, 2, 2, 2, 5, Blocks.hay_block.getDefaultState(), Blocks.hay_block.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 2, 1, 7, 2, 2, 11, Blocks.hay_block.getDefaultState(), Blocks.hay_block.getDefaultState(), false);
            
            this.spawnVillagers(worldIn, p_74875_3_, 4, 1, 4, 0);
            this.spawnVillagers(worldIn, p_74875_3_, 4, 1, 7, 1);
            return true;
        }
