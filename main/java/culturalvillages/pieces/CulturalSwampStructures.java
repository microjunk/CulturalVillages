...
public class CulturalSwampStructures
{
	private static final String __OBFID = "CL_00000516";

	public static void registerVillagePieces()
    {
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.House1.class, "House1");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Field1.class, "Field1");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Field2.class, "Field2");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Torch.class, "Torch");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Hall.class, "Hall");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.House4Garden.class, "House4");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.WoodHut.class, "WoodHut");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Church.class, "Church");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.House2.class, "House2");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Start.class, "Start");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Path.class, "Path");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.House3.class, "House3");
        MapGenStructureIO.registerStructureComponent(CulturalSwampStructures.Well.class, "Well");
    }

    public static List getStructureVillageWeightedPieceList(Random p_75084_0_, int p_75084_1_)
    {
        ArrayList arraylist = Lists.newArrayList();
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.House4Garden.class, 4, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.Church.class, 20, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 1 + p_75084_1_)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.House1.class, 20, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.WoodHut.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 5 + p_75084_1_ * 3)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.Hall.class, 15, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 2 + p_75084_1_)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.Field1.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 1 + p_75084_1_, 4 + p_75084_1_)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.Field2.class, 3, MathHelper.getRandomIntegerInRange(p_75084_0_, 2 + p_75084_1_, 4 + p_75084_1_ * 2)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.House2.class, 15, MathHelper.getRandomIntegerInRange(p_75084_0_, 0, 1 + p_75084_1_)));
        arraylist.add(new CulturalSwampStructures.PieceWeight(CulturalSwampStructures.House3.class, 8, MathHelper.getRandomIntegerInRange(p_75084_0_, 0 + p_75084_1_, 3 + p_75084_1_ * 2)));
        ...
        {
            if (((CulturalSwampStructures.PieceWeight)iterator.next()).villagePiecesLimit == 0)
            {
                iterator.remove();
            }
        }
    ...
    private static int func_75079_a(List p_75079_0_)
    {
        boolean flag = false;
        int i = 0;
        CulturalSwampStructures.PieceWeight pieceweight;

        for (Iterator iterator = p_75079_0_.iterator(); iterator.hasNext(); i += pieceweight.villagePieceWeight)
        {
            pieceweight = (CulturalSwampStructures.PieceWeight)iterator.next();
    ...
    private static CulturalSwampStructures.Village func_176065_a(CulturalSwampStructures.Start p_176065_0_, CulturalSwampStructures.PieceWeight p_176065_1_, List p_176065_2_, Random p_176065_3_, int p_176065_4_, int p_176065_5_, int p_176065_6_, EnumFacing p_176065_7_, int p_176065_8_)
    {
        Class oclass = p_176065_1_.villagePieceClass;
        Object object = null;

        if (oclass == CulturalSwampStructures.House4Garden.class)
        {
            object = CulturalSwampStructures.House4Garden.func_175858_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.Church.class)
        {
            object = CulturalSwampStructures.Church.func_175854_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.House1.class)
        {
            object = CulturalSwampStructures.House1.func_175850_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.WoodHut.class)
        {
            object = CulturalSwampStructures.WoodHut.func_175853_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.Hall.class)
        {
            object = CulturalSwampStructures.Hall.func_175857_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.Field1.class)
        {
            object = CulturalSwampStructures.Field1.func_175851_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.Field2.class)
        {
            object = CulturalSwampStructures.Field2.func_175852_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.House2.class)
        {
            object = CulturalSwampStructures.House2.func_175855_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else if (oclass == CulturalSwampStructures.House3.class)
        {
            object = CulturalSwampStructures.House3.func_175849_a(p_176065_0_, p_176065_2_, p_176065_3_, p_176065_4_, p_176065_5_, p_176065_6_, p_176065_7_, p_176065_8_);
        }
        else
        {
        ...
        return (CulturalSwampStructures.Village)object;
    }

    private static CulturalSwampStructures.Village func_176067_c(CulturalSwampStructures.Start p_176067_0_, List p_176067_1_, Random p_176067_2_, int p_176067_3_, int p_176067_4_, int p_176067_5_, EnumFacing p_176067_6_, int p_176067_7_)
    {
        ...
        else
        {
            ...
            while (j1 < 5)
            {
                ...
                while (iterator.hasNext())
                {
                    CulturalSwampStructures.PieceWeight pieceweight = (CulturalSwampStructures.PieceWeight)iterator.next();
                    ...
                    if (k1 < 0)
                    {
                        ...
                        CulturalSwampStructures.Village village = func_176065_a(p_176067_0_, pieceweight, p_176067_1_, p_176067_2_, p_176067_3_, p_176067_4_, p_176067_5_, p_176067_6_, p_176067_7_);
            ...
            StructureBoundingBox structureboundingbox = CulturalSwampStructures.Torch.func_175856_a(p_176067_0_, p_176067_1_, p_176067_2_, p_176067_3_, p_176067_4_, p_176067_5_, p_176067_6_);

            if (structureboundingbox != null)
            {
                return new CulturalSwampStructures.Torch(p_176067_0_, p_176067_7_, p_176067_2_, structureboundingbox, p_176067_6_);
            }
            else
            {
                return null;
    ...
    private static StructureComponent func_176066_d(CulturalSwampStructures.Start p_176066_0_, List p_176066_1_, Random p_176066_2_, int p_176066_3_, int p_176066_4_, int p_176066_5_, EnumFacing p_176066_6_, int p_176066_7_)
    {
        if (p_176066_7_ > 50)
        {
            return null;
        ...
        {
            CulturalSwampStructures.Village village = func_176067_c(p_176066_0_, p_176066_1_, p_176066_2_, p_176066_3_, p_176066_4_, p_176066_5_, p_176066_6_, p_176066_7_ + 1);
    ...
    private static StructureComponent func_176069_e(CulturalSwampStructures.Start p_176069_0_, List p_176069_1_, Random p_176069_2_, int p_176069_3_, int p_176069_4_, int p_176069_5_, EnumFacing p_176069_6_, int p_176069_7_)
    {
        ...
        {
            StructureBoundingBox structureboundingbox = CulturalSwampStructures.Path.func_175848_a(p_176069_0_, p_176069_1_, p_176069_2_, p_176069_3_, p_176069_4_, p_176069_5_, p_176069_6_);

            if (structureboundingbox != null && structureboundingbox.minY > 10)
            {
                CulturalSwampStructures.Path path = new CulturalSwampStructures.Path(p_176069_0_, p_176069_7_, p_176069_2_, structureboundingbox, p_176069_6_);
    ...
    public static class Church extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000525";

        public Church() {}

        public Church(CulturalSwampStructures.Start p_i45564_1_, int p_i45564_2_, Random p_i45564_3_, StructureBoundingBox p_i45564_4_, EnumFacing p_i45564_5_)
        {
        ...
        public static CulturalSwampStructures.Church func_175854_a(CulturalSwampStructures.Start p_175854_0_, List p_175854_1_, Random p_175854_2_, int p_175854_3_, int p_175854_4_, int p_175854_5_, EnumFacing p_175854_6_, int p_175854_7_)
        {
            StructureBoundingBox structureboundingbox = StructureBoundingBox.func_175897_a(p_175854_3_, p_175854_4_, p_175854_5_, 0, 0, 0, 7, 10, 13, p_175854_6_);
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175854_1_, structureboundingbox) == null ? new CulturalSwampStructures.Church(p_175854_0_, p_175854_7_, p_175854_2_, structureboundingbox, p_175854_6_) : null;
        }
        ...
        public boolean addComponentParts(World worldIn, Random p_74875_2_, StructureBoundingBox p_74875_3_)
        {
            ...
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 0, 7, 10, 13, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            //this.func_175804_a(world, p_74875_3_, 1, 5, 1, 3, 9, 3, Blocks.air.getDefaultState(), Blocks.air.getDefaultState(), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 3, 0, 2, 3, Blocks.log.getStateFromMeta(3), Blocks.log.getStateFromMeta(3), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 0, 10, 0, 2, 10, Blocks.log.getStateFromMeta(3), Blocks.log.getStateFromMeta(3), false);
            this.func_175804_a(worldIn, p_74875_3_, 7, 0, 3, 7, 2, 3, Blocks.log.getStateFromMeta(3), Blocks.log.getStateFromMeta(3), false);
            this.func_175804_a(worldIn, p_74875_3_, 7, 0, 10, 7, 2, 10, Blocks.log.getStateFromMeta(3), Blocks.log.getStateFromMeta(3), false);
            this.func_175804_a(worldIn, p_74875_3_, 0, 3, 0, 7, 3, 12, Blocks.log.getStateFromMeta(3), Blocks.log.getStateFromMeta(3), false);
            this.func_175811_a(worldIn, Blocks.log.getStateFromMeta(3), 0, 4, 4, p_74875_3_);
            this.func_175804_a(worldIn, p_74875_3_, 0, 4, 5, 0, 4, 9, Blocks.planks.getDefaultState(), Blocks.planks.getDefaultState(), false);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 0, 4, 10, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 1, 4, 3, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.log.getDefaultState(), 1, 4, 11, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.planks.getDefaultState(), 2, 4, 3, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.planks.getDefaultState(), 2, 4, 9, p_74875_3_);
            this.func_175811_a(worldIn, Blocks.planks.getDefaultState(), 2, 4, 11, p_74875_3_);
            //this.fillWithMetadataBlocks(world, p_74875_3_, 1, 4, 1, 3, 4, 3, Blocks.wooden_slab, 8, Blocks.wooden_slab, 8, false);
            //this.placeBlockAtCurrentPosition(world, Blocks.cobblestone, 0, 0, 11, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.cobblestone, 0, 4, 11, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.cobblestone, 0, 2, 11, 0, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.cobblestone, 0, 2, 11, 4, p_74875_3_);
            //this.fillWithBlocks(world, p_74875_3_, 1, 0, 1, 3, 0, 7, Blocks.double_stone_slab, Blocks.double_stone_slab, false);
            //this.fillWithBlocks(world, p_74875_3_, 1, 1, 6, 3, 1, 7, Blocks.stone_slab, Blocks.stone_slab, false);
            //this.placeBlockAtCurrentPosition(world, Blocks.double_stone_slab, 0, 2, 1, 6, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.stone_slab, 0, 2, 2, 6, p_74875_3_);
            ...
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 4, 2, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 4, 3, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 0, 6, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 0, 7, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 4, 6, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 4, 7, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 2, 6, 0, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 2, 7, 0, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 2, 6, 4, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 2, 7, 4, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 0, 3, 6, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 4, 3, 6, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.glass_pane, 0, 2, 3, 8, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.torch, DirectionTools.torch[coordBaseMode][3], 1, 3, 7, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.torch, DirectionTools.torch[coordBaseMode][3], 3, 3, 7, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.torch, DirectionTools.torch[coordBaseMode][2], 2, 3, 1, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.wooden_slab, 8, 1, 5, 1, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.torch, 5, 1, 6, 1, p_74875_3_);
                
            //i = this.getMetadataWithOffset(Blocks.ladder, 4);
            //for (j = 1; j <= 9; ++j)
            //{
            //    this.placeBlockAtCurrentPosition(world, Blocks.ladder, i, 3, j, 1, p_74875_3_);
            //}

            //this.placeBlockAtCurrentPosition(world, Blocks.air, 0, 2, 1, 0, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.air, 0, 2, 2, 0, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.double_stone_slab, 0, 2, 0, 0, p_74875_3_);
            //this.placeDoorAtCurrentPosition(world, p_74875_3_, random, 2, 1, 0, this.getMetadataWithOffset(Blocks.wooden_door, 1));

            //if (this.getBlockAtCurrentPosition(world, 2, 0, -1, p_74875_3_).getMaterial() == Material.air && this.getBlockAtCurrentPosition(world, 2, -1, -1, p_74875_3_).getMaterial() != Material.air)
            //{
            //    this.placeBlockAtCurrentPosition(world, Blocks.stone_stairs, this.getMetadataWithOffset(Blocks.stone_stairs, 3), 2, 0, -1, p_74875_3_);
            //}
                
            //this.fillWithMetadataBlocks(world, p_74875_3_, 2,  1, 1, 2, 1, 5, Blocks.carpet, 14, Blocks.carpet, 14, false);

            //this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], 1, 1, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], 3, 1, 2, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], 1, 1, 4, p_74875_3_);
            //this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], 3, 1, 4, p_74875_3_);

            //for (int k =0; k < 4; k ++)
            //{
            //    this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][0], 0, 5, 4+k, p_74875_3_);
            //    this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][1], 4, 5, 4+k, p_74875_3_);
            //	if (k < 3) {
            //        this.placeBlockAtCurrentPosition(world, Blocks.oak_stairs, DirectionTools.stair[coordBaseMode][2], 1+k, 5, 8, p_74875_3_);
            //	}
            //}
                
            this.spawnVillagers(worldIn, p_74875_3_, 2, 1, 2, 0);
    ...
    public static class Field1 extends CulturalSwampStructures.Village
    {
        ...
        public Field1(CulturalSwampStructures.Start p_i45570_1_, int p_i45570_2_, Random p_i45570_3_, StructureBoundingBox p_i45570_4_, EnumFacing p_i45570_5_)
        {
        ...
        public static CulturalSwampStructures.Field1 func_175851_a(CulturalSwampStructures.Start p_175851_0_, List p_175851_1_, Random p_175851_2_, int p_175851_3_, int p_175851_4_, int p_175851_5_, EnumFacing p_175851_6_, int p_175851_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175851_1_, structureboundingbox) == null ? new CulturalSwampStructures.Field1(p_175851_0_, p_175851_7_, p_175851_2_, structureboundingbox, p_175851_6_) : null;
        }
    ...
    public static class Field2 extends CulturalSwampStructures.Village
    {
        /** First crop type for this field. */
        private Block cropTypeA;
        /** Second crop type for this field. */
        ...
        public Field2(CulturalSwampStructures.Start p_i45569_1_, int p_i45569_2_, Random p_i45569_3_, StructureBoundingBox p_i45569_4_, EnumFacing p_i45569_5_)
        {
        ...
        public static CulturalSwampStructures.Field2 func_175852_a(CulturalSwampStructures.Start p_175852_0_, List p_175852_1_, Random p_175852_2_, int p_175852_3_, int p_175852_4_, int p_175852_5_, EnumFacing p_175852_6_, int p_175852_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175852_1_, structureboundingbox) == null ? new CulturalSwampStructures.Field2(p_175852_0_, p_175852_7_, p_175852_2_, structureboundingbox, p_175852_6_) : null;
        }
    ...
    public static class Hall extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000522";

        public Hall() {}

        public Hall(CulturalSwampStructures.Start p_i45567_1_, int p_i45567_2_, Random p_i45567_3_, StructureBoundingBox p_i45567_4_, EnumFacing p_i45567_5_)
        {
        ...
        public static CulturalSwampStructures.Hall func_175857_a(CulturalSwampStructures.Start p_175857_0_, List p_175857_1_, Random p_175857_2_, int p_175857_3_, int p_175857_4_, int p_175857_5_, EnumFacing p_175857_6_, int p_175857_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175857_1_, structureboundingbox) == null ? new CulturalSwampStructures.Hall(p_175857_0_, p_175857_7_, p_175857_2_, structureboundingbox, p_175857_6_) : null;
        }
    ...
    public static class House1 extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000517";

        public House1() {}

        public House1(CulturalSwampStructures.Start p_i45571_1_, int p_i45571_2_, Random p_i45571_3_, StructureBoundingBox p_i45571_4_, EnumFacing p_i45571_5_)
        {
        ...
        public static CulturalSwampStructures.House1 func_175850_a(CulturalSwampStructures.Start p_175850_0_, List p_175850_1_, Random p_175850_2_, int p_175850_3_, int p_175850_4_, int p_175850_5_, EnumFacing p_175850_6_, int p_175850_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175850_1_, structureboundingbox) == null ? new CulturalSwampStructures.House1(p_175850_0_, p_175850_7_, p_175850_2_, structureboundingbox, p_175850_6_) : null;
        }
    ...
    public static class House2 extends CulturalSwampStructures.Village
    {
        ...
        public House2(CulturalSwampStructures.Start p_i45563_1_, int p_i45563_2_, Random p_i45563_3_, StructureBoundingBox p_i45563_4_, EnumFacing p_i45563_5_)
        {
        ...
        public static CulturalSwampStructures.House2 func_175855_a(CulturalSwampStructures.Start p_175855_0_, List p_175855_1_, Random p_175855_2_, int p_175855_3_, int p_175855_4_, int p_175855_5_, EnumFacing p_175855_6_, int p_175855_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175855_1_, structureboundingbox) == null ? new CulturalSwampStructures.House2(p_175855_0_, p_175855_7_, p_175855_2_, structureboundingbox, p_175855_6_) : null;
        }
    ...
    public static class House3 extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000530";

        public House3() {}

        public House3(CulturalSwampStructures.Start p_i45561_1_, int p_i45561_2_, Random p_i45561_3_, StructureBoundingBox p_i45561_4_, EnumFacing p_i45561_5_)
        {
        ...
        public static CulturalSwampStructures.House3 func_175849_a(CulturalSwampStructures.Start p_175849_0_, List p_175849_1_, Random p_175849_2_, int p_175849_3_, int p_175849_4_, int p_175849_5_, EnumFacing p_175849_6_, int p_175849_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175849_1_, structureboundingbox) == null ? new CulturalSwampStructures.House3(p_175849_0_, p_175849_7_, p_175849_2_, structureboundingbox, p_175849_6_) : null;
        }
    ...
    public static class House4Garden extends CulturalSwampStructures.Village
    {
        ...
        public House4Garden(CulturalSwampStructures.Start p_i45566_1_, int p_i45566_2_, Random p_i45566_3_, StructureBoundingBox p_i45566_4_, EnumFacing p_i45566_5_)
        {
        ...
        public static CulturalSwampStructures.House4Garden func_175858_a(CulturalSwampStructures.Start p_175858_0_, List p_175858_1_, Random p_175858_2_, int p_175858_3_, int p_175858_4_, int p_175858_5_, EnumFacing p_175858_6_, int p_175858_7_)
        {
            ...
            return StructureComponent.findIntersecting(p_175858_1_, structureboundingbox) != null ? null : new CulturalSwampStructures.House4Garden(p_175858_0_, p_175858_7_, p_175858_2_, structureboundingbox, p_175858_6_);
        }
    ...
    public static class Path extends CulturalSwampStructures.Road
    {
        ...
        public Path(CulturalSwampStructures.Start p_i45562_1_, int p_i45562_2_, Random p_i45562_3_, StructureBoundingBox p_i45562_4_, EnumFacing p_i45562_5_)
        {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
        {
            ...
            {
                structurecomponent1 = this.getNextComponentNN((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, i);
            ...
            for (i = p_74861_3_.nextInt(5); i < this.averageGroundLevel - 8; i += 2 + p_74861_3_.nextInt(5))
            {
                structurecomponent1 = this.getNextComponentPP((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, 0, i);
            ...
            {
                switch (CulturalSwampStructures.SwitchEnumFacing.field_176064_a[this.coordBaseMode.ordinal()])
                {
                    case 1:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.WEST, this.getComponentType());
                        break;
                    case 2:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.WEST, this.getComponentType());
                        break;
                    case 3:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                        break;
                    case 4:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
            ...
            if (flag && p_74861_3_.nextInt(3) > 0 && this.coordBaseMode != null)
            {
                ...
                {
                    case 1:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.minZ, EnumFacing.EAST, this.getComponentType());
                        break;
                    case 2:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.minY, this.boundingBox.maxZ - 2, EnumFacing.EAST, this.getComponentType());
                        break;
                    case 3:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                        break;
                    case 4:
                        CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX - 2, this.boundingBox.minY, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
        }

        public static StructureBoundingBox func_175848_a(CulturalSwampStructures.Start p_175848_0_, List p_175848_1_, Random p_175848_2_, int p_175848_3_, int p_175848_4_, int p_175848_5_, EnumFacing p_175848_6_)
        {
    ...
    public abstract static class Road extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000532";

        public Road() {}

        protected Road(CulturalSwampStructures.Start p_i2108_1_, int p_i2108_2_)
        {
            super(p_i2108_1_, p_i2108_2_);
        }
    }

    public static class Start extends CulturalSwampStructures.Well
    {
        ...
        public CulturalSwampStructures.PieceWeight structVillagePieceWeight;
        /**
        ...
        {
            super((CulturalSwampStructures.Start)null, 0, p_i2104_3_, p_i2104_4_, p_i2104_5_);
    ...
    public static class Torch extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000520";

        public Torch() {}

        public Torch(CulturalSwampStructures.Start p_i45568_1_, int p_i45568_2_, Random p_i45568_3_, StructureBoundingBox p_i45568_4_, EnumFacing p_i45568_5_)
        {
        ...
        public static StructureBoundingBox func_175856_a(CulturalSwampStructures.Start p_175856_0_, List p_175856_1_, Random p_175856_2_, int p_175856_3_, int p_175856_4_, int p_175856_5_, EnumFacing p_175856_6_)
        {
    ...
    public abstract static class Village extends StructureComponent
    {
        ...
        private CulturalSwampStructures.Start startPiece;

        public Village() {}

        protected Village(CulturalSwampStructures.Start p_i2107_1_, int p_i2107_2_)
        {
            super(p_i2107_2_);
         ...
         */
        protected StructureComponent getNextComponentNN(CulturalSwampStructures.Start p_74891_1_, List p_74891_2_, Random p_74891_3_, int p_74891_4_, int p_74891_5_)
        {
            if (this.coordBaseMode != null)
            {
                ...
                {
                    case 1:
                        return CulturalSwampStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    case 2:
                        return CulturalSwampStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX - 1, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ + p_74891_5_, EnumFacing.WEST, this.getComponentType());
                    case 3:
                        return CulturalSwampStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                    case 4:
                        return CulturalSwampStructures.func_176066_d(p_74891_1_, p_74891_2_, p_74891_3_, this.boundingBox.minX + p_74891_5_, this.boundingBox.minY + p_74891_4_, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
                }
            }
         ...
         * Gets the next village component, with the bounding box shifted +1 in the X and Z direction.
         */
        protected StructureComponent getNextComponentPP(CulturalSwampStructures.Start p_74894_1_, List p_74894_2_, Random p_74894_3_, int p_74894_4_, int p_74894_5_)
        {
            if (this.coordBaseMode != null)
            {
                switch (CulturalSwampStructures.SwitchEnumFacing.field_176064_a[this.coordBaseMode.ordinal()])
                {
                    case 1:
                        return CulturalSwampStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    case 2:
                        return CulturalSwampStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.maxX + 1, this.boundingBox.minY + p_74894_4_, this.boundingBox.minZ + p_74894_5_, EnumFacing.EAST, this.getComponentType());
                    case 3:
                        return CulturalSwampStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                    case 4:
                        return CulturalSwampStructures.func_176066_d(p_74894_1_, p_74894_2_, p_74894_3_, this.boundingBox.minX + p_74894_5_, this.boundingBox.minY + p_74894_4_, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
                }
            }
    ...
    public static class Well extends CulturalSwampStructures.Village
    {
        private static final String __OBFID = "CL_00000533";

        public Well() {}

        public Well(CulturalSwampStructures.Start p_i2109_1_, int p_i2109_2_, Random p_i2109_3_, int p_i2109_4_, int p_i2109_5_)
        {
        ...
        public void buildComponent(StructureComponent p_74861_1_, List p_74861_2_, Random p_74861_3_)
        {
            CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.WEST, this.getComponentType());
            CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, EnumFacing.EAST, this.getComponentType());
            CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, EnumFacing.NORTH, this.getComponentType());
            CulturalSwampStructures.func_176069_e((CulturalSwampStructures.Start)p_74861_1_, p_74861_2_, p_74861_3_, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, EnumFacing.SOUTH, this.getComponentType());
        }
    ...
    public static class WoodHut extends CulturalSwampStructures.Village
    {
        ...
        public WoodHut(CulturalSwampStructures.Start p_i45565_1_, int p_i45565_2_, Random p_i45565_3_, StructureBoundingBox p_i45565_4_, EnumFacing p_i45565_5_)
        {
        ...
        public static CulturalSwampStructures.WoodHut func_175853_a(CulturalSwampStructures.Start p_175853_0_, List p_175853_1_, Random p_175853_2_, int p_175853_3_, int p_175853_4_, int p_175853_5_, EnumFacing p_175853_6_, int p_175853_7_)
        {
            ...
            return canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(p_175853_1_, structureboundingbox) == null ? new CulturalSwampStructures.WoodHut(p_175853_0_, p_175853_7_, p_175853_2_, structureboundingbox, p_175853_6_) : null;
        }
