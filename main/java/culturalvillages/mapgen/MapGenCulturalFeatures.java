...
public class MapGenCulturalFeatures extends MapGenScatteredFeature
{
    ...
    public MapGenCulturalFeatures(Map p_i2061_1_)
    {
        this();
    ...
    {
        return CulturalVillages.NAME + ".Temple";
    }
    ...
    {
        return new MapGenCulturalFeatures.Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_);
    }
    ...
    public boolean func_175798_a(BlockPos p_175798_1_)
    {
        ...
        if (structurestart != null && structurestart instanceof MapGenCulturalFeatures.Start && !structurestart.getComponents().isEmpty())
        {
